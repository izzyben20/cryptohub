...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails.numberOfMarkets && millify(cryptoDetails.numberOfMarkets)}`, icon: <ThunderboltOutlined /> },
  ...
  const genericStats = [
    ...
    { title: 'Approved Supply', value: cryptoDetails.supply.total ? <CheckOutlined /> : <StopOutlined />, icon: <ExclamationCircleOutlined /> },
    ...
    return (
        <Col className="coin-detail-container">
            <Col className="coin-heading-container">
                <Title level={3} className="coin-name">{cryptoDetails.name} ({cryptoDetails.symbol}) Price</Title>
            ...
            <Col className="stats-container">
                <Col className="coin-value-statistics">
                    <Col className="coin-value-statistics.heading">
                        <Title level={4} className="coin-details-heading">{cryptoDetails.name} Value Statistics</Title>
                ...
                <Col className="other-stats-info">
                    <Col className="coin-value-statistics.heading">
                        <Title level={4} className="coin-details-heading">Other Statistics</Title>
            ...
            <Col className="coin-desc-link">
                <Row className="coin-desc">
                    <Title level={4} className="coin-details-heading">What is {cryptoDetails.name}
                    {HTMLReactParser(cryptoDetails.description)}
                    </Title>
                </Row>
                <Col className="coin-links">
                    <Title level={4} className="coin-details-heading">{cryptoDetails.name}</Title>
